...
public class CamMenuList {
    ...
    static ArrayList< CamDetails > cameraList = new ArrayList<>( );
    

    static MyWallet wallet = new MyWallet( );
    public static void intialCameraValue(){
    	cameraList.add(new CamDetails("Canon", "EOS2D", 1000.0));
    	cameraList.add(new CamDetails("Nikon", "D3500", 1255.0));
    	cameraList.add(new CamDetails("Kodak", "D2500", 2500.0));
    	cameraList.add(new CamDetails("Canon", "D6500", 4000.0));
    	cameraList.add(new CamDetails("Canon", "D3700", 5000.0));
    }
   ...
   /* Add camera in list*/
    private static void addCam( ) {
         try{
             ...
             if ( cameraList.add( new CamDetails( brand, model, price ) ) ) {
    ...
    private static void displayCam() {
        ...
        System.out.println("----------------------------------------------------------------------------------");
        for ( CamDetails camera : cameraList ) {
            if ( camera.getStatus( ) ) {
